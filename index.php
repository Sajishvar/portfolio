	...
	<div class="container">
		<div class="row justify-content-center pb-5">
			<div class="col-md-12 heading-section text-center ftco-animate">
				...
				<p>Skilled in web development and software engineering, with a solid foundation in HTML, CSS, JavaScript, PHP, and expertise in creating efficient, user-centered digital solutions.</p>
			</div>
		</div>
		<div class="row">
